...
class _AssetInfoState extends State<AssetInfo> {
  ...
  Future<void> sortList() async {
    _checkAll = List.from(_checkInList)
      ..addAll(_checkOutList);
          ...
          headerSliverBuilder: (BuildContext context, bool innerBox) {
            return [
              SliverAppBar(
                ...
                leading: Container(),
                backgroundColor: isDarkTheme ? hexaCodeToColor(
                          ...
                          child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  MyText(
                                    fontSize: 18.0,
                                    color: isDarkTheme ? "#FFFFFF" : AppColors
                                        .blackColor,
                                    text: widget.id == null
                                        ? widget.tokenSymbol
                                  ...
                                  Align(
                                      ...
                                      child: MyText(
                                        fontSize: 16.0,
                                        text: widget.org == 'BEP-20'
                                            ? 'BEP-20'
                                            : '',
                                        color: isDarkTheme ? AppColors
                                            .whiteHexaColor : AppColors
                                            .darkCard,
                                      )
                                  ),
                                ],
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                MyText(
                                  ...
                                  fontSize: 14,
                                  fontWeight: FontWeight.bold,
                                  color: widget.priceChange24h.substring(
                                      0, 1) == '-'
                                      ? '#FF0000'
                                      : isDarkTheme
                                      ? '#00FF00'
